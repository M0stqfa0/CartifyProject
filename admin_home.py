...
class AdminHomePage(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        signout_btn = ctk.CTkButton(header, text="", font=BUTTON_FONT, image=ctk.CTkImage(dark_image=Image.open("images/logout.png"), size=(35, 35)),
                                    width=80, height=40, fg_color="transparent", hover_color="#48464f",
                                    command=self.sign_out)
        signout_btn.grid(row=0, column=4, padx=(10, 20), pady=10)
        ...
        title_label = ctk.CTkLabel(self.title_frame, text="Admin Homepage", font=("Segoe UI", 22, "bold"))
